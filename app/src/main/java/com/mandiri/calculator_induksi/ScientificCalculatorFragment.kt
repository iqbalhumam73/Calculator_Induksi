...
class ScientificCalculatorFragment : Fragment(), OperationChange {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.apply {
            ...
            btnSin.setOnClickListener(){
                currentOperation = addToOperation("${interactionListener?.getTvOperation()}", "sin(")
                interactionListener?.tvOperationChange(currentOperation)
            }
            btnCos.setOnClickListener(){
                currentOperation = addToOperation("${interactionListener?.getTvOperation()}", "cos(")
                interactionListener?.tvOperationChange(currentOperation)
            }
            btnTan.setOnClickListener(){
                currentOperation = addToOperation("${interactionListener?.getTvOperation()}", "tan(")
                interactionListener?.tvOperationChange(currentOperation)
            }
        }
